...
import { dashboardHtml, comingSoonHtml, adminColinkerySectionHtml, qrRegisterHtml, adminQrHtml, walletHtml, teamConfirmHtml, coworkeryAppHtml, brandFormHtml, memberProfileHtml, colinkerypwaHtml, partnerApplyHtml , qrCompleteHtml , sopHtml , posterHtml , loginHtml , homeHtml } from './lib/html-templates'
